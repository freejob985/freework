                    ...
                    <div class="media-body d-lg-flex justify-content-between align-items-center">
                        <div class="mr-3 mb-4 mb-lg-0 text-center text-md-left">
                            ...
                            <div
                                ...
                                @php
                                $exist = DB::table('exist')->where('user', $freelancer->id)->value('exist');
                     
                                @endphp
                                @if(!empty($exist))
                                <div>
                                    <i class="las la-clock"></i>  
                                    <span><span>اخر تواجد : {{ Carbon\Carbon::parse($exist)->diffForHumans() }} </span></span>
                                </div>
                                @endif
    ...
    <div class="container">
        <div class="row gutters-10">
            <div class="col-xxl-9 col-lg-8 order-1 order-lg-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            <ul class="list-group list-group-flush">
                                @foreach (\App\Models\Review::where('published', 1)->where('reviewed_user_id',
                                $freelancer->id)->get() as $key => $review)
                                <li class="list-group-item px-0">
                                    <div class="media">
                                        <div class="mr-3">
                                            <span class="avatar avatar-md m-3">
                                                <img
                                                    src="{{ custom_asset(\App\User::find($review->reviewer_user_id)->photo) }}">
                                            </span>
                                        </div>
                                        <div class="media-body">
                                            <div class="d-flex justify-content-between align-items-start mb-3">
                                                <div>
                                                    @if ($review->project)
                                                    <h4 class="fw-600 fs-14 mb-1 lh-1-6">{{ $review->project->name }}
                                                    </h4>
                                                    @else
                ...
                @if (count($Other_specialties_array)>0)
                <div class="card">
                    <div class="card-header">
                        <h4 class="h6 fw-600 mb-0">تخصصات اخري</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <span style="
                                    ...
                                    padding: 1%;
                                    border-radius: 7%;
                                " class="label label-primary">{{ $key  }}</span>&nbsp;
                        @endforeach
                    </div>
                </div>
                @endif
                        ...
                        <div class="">
                            ...
                            <div>
                                <ul class="list-unstyled">
                                    @php
                                    $verification = \App\Models\Verification::where('user_id',
                                    $freelancer->id)->where('type', 'identity_verification')->first();
                                    @endphp
