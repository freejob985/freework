                        ...
                        <tbody>
                            @foreach($projects as $key => $project)
                                <tr>
                                   ...
                                   <td>
                                       <a href="{{ route('Reasons.rejection', [$project->client->id,$project->id,"project"]) }}" class="btn btn-warning">اسباب الرفض</a>
                                       {{--  <a href="{{ route('user.edit', [$project->client->id]) }}" class="btn btn-success" target="_blank">تسجيل الدخول</a>  --}}
