        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    ...
                    <a class="menu-a"
                        href="http://sub.digi-gate.com/search?keyword=&type=freelancer">{{ translate('Freelancers') }}</a>
                    <a class="menu-a"
                        href="http://sub.digi-gate.com/search?keyword=&type=project">{{ translate('Projects') }}</a>
                    <a class="menu-a"
                        href="http://sub.digi-gate.com/search?keyword=&type=service">{{ translate('Services') }}</a>
                </div>
                        ...
                        <form action="{{ route('search') }}" method="GET" class="flex-grow-1">
                            <div class="input-group">
                                ...
                                <select class="form-control aiz-selectpicker" name="type">
                                    <option value="freelancer" @isset($type) @if ($type=='freelancer' ) selected @endif
                                        @endisset>{{ translate('Freelancers') }}</option>
                                    <option value="project" @isset($type) @if ($type=='project' ) selected @endif
                        ...
                        <ul class="navbar-nav ml-auto align-items-center">
                            ...
                            <li class="dropdown d-none d-lg-block">
                                ...
                                <div
                                    ...
                                    <div class="c-scrollbar-light" style="overflow-y:auto;max-height:300px;">
                                        ...
                                        @php
                                        $chat = \App\Models\Chat::where('chat_thread_id',
                                        $chat_thread_id)->latest()->first();
                                        @endphp
                                        @if ($chat != null)
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body minw-0">
                                                    ...
                                                    <h6 class="mt-0 mb-1 fs-14 text-truncate">
                                                        {{ $chat->chatThread->receiver->name }}</h6>
                                                    @else
                                                    <h6 class="mt-0 mb-1 fs-14 text-truncate">
                                                        {{ $chat->chatThread->sender->name }}</h6>
                                                    @endif
                                                    @if ($chat->message != null)
                                                    <div class="fs-12 text-truncate opacity-60">{{ $chat->message }}
                                                    </div>
                                                    @else
                            ...
                            <li class="dropdown ml-3 d-none d-lg-block">
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-menu-right"
                                    ...
                                    @endif     
                                    @if (isFreelancer())
                                    <a class="dropdown-item" href="{{Request::root()}}/Terms-Conditions-services">
                                        <i class="las la-tachometer-alt"></i>
