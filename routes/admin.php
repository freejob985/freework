...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::get('/freelancer-package-index/all/{type}', 'PackageController@index')->name('comprehensive_package.index');
...
//=======================================
    Route::get('/Reasons-rejection/{id}/{prog}/{services?}', 'Developer@Reasons')->name('Reasons.rejection');
    Route::post('/Reasons-rejection/send', 'Developer@Reasons_send')->name('Reasons.rejection.send');
    Route::get('/user/edit/{id}', 'Developer@login_user_get')->name('user.edit');
    Route::post('/services/approval-status', 'Developer@project_approval')->name('project_approval.services');
//=======================================
