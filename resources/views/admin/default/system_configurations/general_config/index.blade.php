...
<div class="row">
    <div class="col-lg-8 mx-auto">
        <div class="card">
                ...
                <form class="form-horizontal" action="{{ route('general-config.store') }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group" data-toggle="aizuploader" data-type="image">
                            ...
                            <input type="hidden" name="system_logo_white" value="{{ get_setting('system_logo_white') }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group" data-toggle="aizuploader" data-type="image">
                            ...
                            <div class="form-control file-amount">{{ translate('Choose Files') }}</div>
                            <input type="hidden" name="system_logo_black" value="{{ get_setting('system_logo_black') }}"
                                class="selected-files">
                        </div>
                        <div class="file-preview box sm"></div>
            ...
            <div class="card-body">
                @php
                $order = DB::table('Maintenance')->value('Status');
                @endphp
