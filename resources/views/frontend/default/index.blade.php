	...
	<div class="container">
		<div class="row" style="float:right;direction:rtl;">
			...
			<div class="col-xl-6 col-lg-8">
				...
				<h1 style="color:#2f5e8c;float:right;" class="fw-700 mb-3 display-4 wow slideInDown">
					{{ get_setting('slider_section_title') }}</h1>
	...
	<div class="container">
		...
		<div class="row gutters-10">
			...
			<div class="cat col-xl-3 col-lg-3 col-md-4 col-6 wow zoomIn">
				<a class="text-center py-3 px-2 d-block card text-inherit shadow-none "
			...
			<div class="aiz-user-panel">
					...
					<div class="col-lg-3">
						<div class="card wow zoomIn">
							<a href="{{ route('service.show', $service->slug) }}"><img
									src="{{ custom_asset($service->image) }}" class="card-img-top" alt="service_image"
									height="212"></a>
							<div class="card-body">
								<div class="d-flex mb-2">
									<span class="mr-2"><img src="{{ custom_asset($service->user->photo) }}" alt="Hello"
											height="35" width="35" class="rounded-circle"></span>
								...
								<a href="{{ route('service.show', $service->slug) }}" class="text-dark">
									<h5 class="card-title">
										{{ \Illuminate\Support\Str::limit($service->title, 40, $end='...') }}</h5>
								</a>
							</div>
				...
				<div class="aiz-pagination aiz-pagination-center">
					<div class="text-center pt-5">
						<a type="button" class="btn btn btn-outline-primary bg-white" style="color: blue;"
							href="{{Request::root()}}/search?keyword=&type=service">{{ translate('All Services') }} </a>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xl-10 mx-auto">
				...
				@php $projects = \App\Models\Project::biddable()->notcancel()->open()->where('project_approval',
				1)->latest()->get()->take(10); @endphp
				@else
				@php $projects = \App\Models\Project::biddable()->notcancel()->open()->latest()->get()->take(10);
				@endphp
				@endif
		...
		<div class="text-center pt-5">
			<a href="{{ route('search') }}?keyword=&type=project"
				class="btn btn btn-outline-primary">{{ translate('Check All Projects') }}</a>
		</div>
	</div>
</section>
@endif
...
<section class="py-4 bg-white border-bottom">
	<div class="container">
		...
		<div class="row align-items-center">
			<div class="aiz-carousel gutters-5" data-autoplay='true' data-items="7" data-xl-items="6" data-lg-items="5"
