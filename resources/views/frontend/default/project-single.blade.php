                ...
                <div class="card project-card">
                        ...
                        <ul class="list-inline opacity-70 fs-13">
                            ...
                            <li class="list-inline-item">
                                <a href="" target="_blank" class="text-inherit">
                                    ...
                                    <span>@if ($project->project_category != null)
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="separator text-left mb-3"><span
                                class="bg-white pr-3">{{ translate('Skills Required') }}</span></h6>
                        <div class="mb-5">
                            ...
                            <a href="{{ route('search.skill', ['skill' => $skill_id, 'type' => 'projects']) }}"
                                class="btn btn-light btn-xs mb-1">{{ $skill->name }}</a>
                            @endif
                            @endforeach
                        </div>
                        <h6 class="separator text-left mb-3"><span
                                class="bg-white pr-3">{{ translate('Attachments') }}</span></h6>
                ...
                <div class="sticky-top z-3">
                    <div class="card project-card">
                        <div class="card-header py-4">
                            ...
                            @php
                            $allow_for_bid = \App\Models\ProjectBid::where('project_id',
                            $project->id)->where('bid_by_user_id', Auth::user()->id)->first();
                            @endphp
                        ...
                        <div class="card-body">
                            <div class="mb-5">
                                <div class="d-flex justify-content-between mb-3">
                                    ...
                                    <span
                                        class="fw-600">{{ str_replace("होरा ","",Carbon\Carbon::parse($project->created_at)->diffForHumans()) }}</span>
                                </div>
                                <div class="d-flex justify-content-between mb-3">
                                    <span class="text-secondary">{{ translate('Posted in') }} -</span>
                                    <span class="fw-600">@if ($project->project_category != null)
                                        {{ $project->project_category->name }} @endif</span>
                                </div>
                                <div class="d-flex justify-content-between mb-3">
                            ...
                            <div>
                                <h6 class="separator mb-4"><span
                                        class="bg-white px-3">{{ translate('About This Client') }}</span></h6>
                                <a href="{{ route('client.details',$project->client->user_name) }}"
                                    ...
                                    <div class="px-4 text-center mb-3">
                                        ...
                                        <h4 class="h5 mb-2 fw-600">@if ($project->client != null)
                                            {{ $project->client->name }} @endif</h4>
                                ...
                                <div class="">
                                    <div class="media mb-3">
                                        ...
                                        <div class="media-body pt-2">
                                            @if ($project->client != null && $project->client->address != null &&
                                    ...
                                    <div class="media">
                                        ...
                                        @php
                                        $exist = DB::table('exist')->where('user', $project->client->id)->value('exist');
                                        ...
                                        <div class="media-body pt-2" >
                                            <span
                                                class="d-block font-weight-medium">{{ Carbon\Carbon::parse($exist)->diffForHumans() }}
                                                اخر تواجد :</span>
                                        </div>
                    ...
                    <div>
                        @if (Auth::check() && ($bookmarked_project = \App\Models\BookmarkedProject::where('user_id',
                        auth()->user()->id)->where('project_id', $project->id)->first()) != null)
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="3" data-xl-items="2"
                    ...
                    @foreach ($similar_types = \App\Models\Project::where('type', $project->type)->where('id', '!=' ,
                    $project->id)->where('closed', '!=', 1)->limit(4)->get() as $similar_type_project)
                            ...
                            <div class="card-header border-bottom-0 pt-4 pb-0 align-items-start minw-0">
                                <h5 class="h6 fw-600 lh-1-5 text-truncate-2 h-45px">
                                    <a href="{{ route('project.details', $similar_type_project->slug) }}"
                                        class="text-inherit" target="_blank">{{ $similar_type_project->name }}</a>
                                </h5>
                            ...
                            <div class="card-body pt-1">
                                ...
                                <ul class="list-inline opacity-70 fs-12">
                                    ...
                                    <li class="list-inline-item">
                                        <a href="" target="_blank" class="text-inherit">
                                            <i class="las la-stream opacity-40"></i>
                                            <span>@if ($similar_type_project->project_category != null)
                                                {{ $similar_type_project->project_category->name }} @endif</span>
                                        </a>
                                    </li>
                                    <li class="list-inline-item">
                                        <i class="las la-handshake"></i>
