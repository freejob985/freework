        ...
        <div class="d-none d-md-flex justify-content-around align-items-center align-items-stretch">
            <div class="aiz-topbar-item">
                <div class="d-flex align-items-center">
                    <a type="button" class="btn btn-success" href="{{ route('home')}}" style="
                    color: white;
                ">الرجوع الي الموقع</a>
                
                    <a style="
                    display: none;
                " class="btn btn-icon btn-circle btn-light" href="{{ route('home')}}" target="_blank" title="{{ translate('Browse Website') }}">
