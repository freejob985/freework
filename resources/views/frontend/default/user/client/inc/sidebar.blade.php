<div class="aiz-user-sidenav-wrap pt-4 sticky-top c-scrollbar-light position-relative z-1">
    ...
    <div class="aiz-user-sidenav rounded overflow-hidden">
        <div class="px-4 text-center mb-4">
            ...
            <div class="mb-1">
                @php
                $profile = \App\Models\UserProfile::where('user_id', Auth::user()->id)->where('user_role_id',
                2)->first();
                @endphp
                <span class="fw-600">
            ...
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('bookmarked-freelancers.index') }}"
                        class="aiz-side-nav-link {{ areActiveRoutes(['bookmarked-freelancers.index'])}}">
                ...
                @endif
                @php
                $total_mile_request = count(\App\Models\MilestonePayment::where('client_user_id',
                Auth::user()->id)->where('client_seen', 0)->get());
                @endphp
                <li class="aiz-side-nav-item">
                    <a href="{{ route('milestone-requests.all') }}"
                        class="aiz-side-nav-link {{ areActiveRoutes(['milestone-requests.all'])}}">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('all.messages') }}"
                        class="aiz-side-nav-link {{ areActiveRoutes(['all.messages', 'chat_view'])}}">
